    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#page-layouts" aria-expanded="false"
               aria-controls="page-layouts"> <img class="menu-icon" src="/admin/images/menu_icons/02.png"
                                                  alt="menu icon"> <span
                    class="menu-title">Page Layouts</span><i class="menu-arrow"></i></a>
            <div class="collapse" id="page-layouts">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="horizontal-menu.html">Horizontal Menu</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="horizontal-menu-2.html">Horizontal Menu 2</a>
                    </li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#apps-dropdown" aria-expanded="false"
               aria-controls="apps-dropdown"> <img class="menu-icon" src="/admin/images/menu_icons/09.png"
                                                   alt="menu icon"> <span class="menu-title">Apps</span><i
        ...
        <li class="nav-item"><a class="nav-link" href="../widgets.html"> <img class="menu-icon"
                                                                              src="/admin/images/menu_icons/08.png"
                                                                              alt="menu icon"> <span
                    class="menu-title">Widgets</span> </a></li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#sidebar-layouts" aria-expanded="false"
               aria-controls="sidebar-layouts"> <img class="menu-icon" src="/admin/images/menu_icons/04.png"
                                                     alt="menu icon"> <span
                    class="menu-title">Sidebar Layouts</span><i class="menu-arrow"></i></a>
            <div class="collapse" id="sidebar-layouts">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="sidebar-hidden-overlay.html">Sidebar
                            Overlay</a></li>
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false"
               aria-controls="ui-basic"> <img class="menu-icon" src="/admin/images/menu_icons/17.png"
                                              alt="menu icon"> <span class="menu-title">Basic UI Elements</span><i
                    class="menu-arrow"></i></a>
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-advanced" aria-expanded="false"
               aria-controls="ui-advanced"> <img class="menu-icon" src="/admin/images/menu_icons/07.png"
                                                 alt="menu icon"> <span
                    class="menu-title">Advanced Elements</span><i class="menu-arrow"></i></a>
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#form-elements" aria-expanded="false"
               aria-controls="form-elements"> <img class="menu-icon" src="/admin/images/menu_icons/19.png"
                                                   alt="menu icon"> <span
                    class="menu-title">Form elements</span><i class="menu-arrow"></i></a>
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#editors" aria-expanded="false"
               aria-controls="editors"> <img class="menu-icon" src="/admin/images/menu_icons/18.png"
                                             alt="menu icon"> <span class="menu-title">Editors</span><i
                    class="menu-arrow"></i></a>
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#charts" aria-expanded="false"
               aria-controls="charts"> <img class="menu-icon" src="/admin/images/menu_icons/03.png"
                                            alt="menu icon"> <span class="menu-title">Charts</span><i
                    class="menu-arrow"></i></a>
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#tables" aria-expanded="false"
               aria-controls="tables"> <img class="menu-icon" src="/admin/images/menu_icons/06.png"
                                            alt="menu icon"> <span class="menu-title">Tables</span><i
                    class="menu-arrow"></i></a>
        ...
        <li class="nav-item"><a class="nav-link" href="../ui-features/popups.html"> <img class="menu-icon"
                                                                                         src="/admin/images/menu_icons/20.png"
                                                                                         alt="menu icon"> <span
                    class="menu-title">Popups</span> </a></li>
        <li class="nav-item"><a class="nav-link" href="../ui-features/notifications.html"> <img
                    class="menu-icon" src="/admin/images/menu_icons/13.png" alt="menu icon"> <span
                    class="menu-title">Notifications</span> </a></li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#icons" aria-expanded="false"
               aria-controls="icons"> <img class="menu-icon" src="/admin/images/menu_icons/10.png"
                                           alt="menu icon"> <span class="menu-title">Icons</span><i
                    class="menu-arrow"></i></a>
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#maps" aria-expanded="false" aria-controls="maps">
                <img class="menu-icon" src="/admin/images/menu_icons/12.png" alt="menu icon"> <span
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#auth" aria-expanded="false" aria-controls="auth">
                <img class="menu-icon" src="/admin/images/menu_icons/01.png" alt="menu icon"> <span
                    class="menu-title">User Pages</span><i class="menu-arrow"></i></a>
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../samples/register-2.html"> Register 2 </a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="../samples/lock-screen.html"> Lockscreen </a>
                    </li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#error" aria-expanded="false"
               aria-controls="error"> <img class="menu-icon" src="/admin/images/menu_icons/16.png"
                                           alt="menu icon"> <span class="menu-title">Error pages</span><i
                    class="menu-arrow"></i></a>
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#general-pages" aria-expanded="false"
               aria-controls="general-pages"> <img class="menu-icon" src="/admin/images/menu_icons/15.png"
                                                   alt="menu icon"> <span
            ...
            <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../samples/news-grid.html"> News grid </a>
                    </li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="../samples/search-results.html"> Search
                            Results </a></li>
                    <li class="nav-item"><a class="nav-link" href="../samples/portfolio.html"> Portfolio </a>
                    </li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#e-commerce" aria-expanded="false"
               aria-controls="e-commerce"> <img class="menu-icon" src="/admin/images/menu_icons/14.png"
                                                alt="menu icon"> <span class="menu-title">E-commerce</span><i
                    class="menu-arrow"></i></a>
        ...
        <li class="nav-item"><a class="nav-link" href="../documentation.html"> <img class="menu-icon"
                                                                                    src="/admin/images/menu_icons/05.png"
                                                                                    alt="menu icon"> <span
