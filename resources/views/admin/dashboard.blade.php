                ...
                <div class="new-accounts">
                    <ul class="chats">
                        <li class="chat-persons">
                            <a href="#">
                                                <span class="pro-pic"><img src="/admin/images/faces/face1.jpg"
                        ...
                        <li class="chat-persons">
                            <a href="#">
                                                <span class="pro-pic"><img src="/admin/images/faces/face2.jpg"
                                                                           alt="profile image"></span>
                                <div class="user">
                        ...
                        <li class="chat-persons">
                            <a href="#">
                                                <span class="pro-pic"><img src="/admin/images/faces/face23.jpg"
                                                                           alt="profile image"></span>
                                <div class="user">
                        ...
                        <li class="chat-persons">
                            <a href="#">
                                                <span class="pro-pic"><img src="/admin/images/faces/face4.jpg"
                                                                           alt="profile image"></span>
                                <div class="user">
                        ...
                        <li class="chat-persons">
                            <a href="#">
                                                <span class="pro-pic"><img src="/admin/images/faces/face14.jpg"
                                                                           alt="profile image"></span>
                                <div class="user">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button type="button" class="btn btn-sm btn-success ml-auto"><i
                            class="mdi mdi-plus"></i>Create New
                    </button>
                </div>
                                    ...
                                    <div class="form-check-label">
                                        ...
                                        <div class="d-flex">
                                            <div class="wrapper todo-content">
                                                <h6 class="mb-1 ellipsis">Anyways i would like just do
                                                    it</h6>
                                                <p class="text-gray mb-0 ellipsor">15:00 PM Mon, 14 Jan
                                                    2018</p>
                                                <span class="text-success ellipsor">#Photoshop</span>
                                            </div>
                                            <div
                                                class="action-wrapper wrapper ml-auto d-flex align-items-center">
                            ...
                            <li class="list">
                                <div class="form-check form-check-flat todo-form-check w-100">
                                    <div class="form-check-label">
                                        ...
                                        <div class="d-flex">
                                            <div class="wrapper todo-content">
                                                <h6 class="mb-1 ellipsis">Make an appointment with
                                                    Doctor</h6>
                                                <p class="text-gray mb-0 ellipsor">10:00 PM Sat, 10 Jan
                                                    2018</p>
                            ...
                            <li class="list">
                                <div class="form-check form-check-flat todo-form-check w-100">
                                    <div class="form-check-label">
                                        ...
                                        <div class="d-flex">
                                            <div class="wrapper todo-content">
                                                <h6 class="mb-1 ellipsis">Visit our boys in Battle
                                                    Exhibition</h6>
                                                <p class="text-gray mb-0 ellipsor">06:46 PM Mon, 02 Jan
                                                    2018</p>
                            ...
                            <li class="list">
                                <div class="form-check form-check-flat todo-form-check w-100">
                                    <div class="form-check-label">
                                        ...
                                        <div class="d-flex">
                                            <div class="wrapper todo-content">
                                                <h6 class="mb-1 ellipsis">Please Checkout The
                                                    Attachment</h6>
                                                <p class="text-gray mb-0 ellipsor">03:00 PM Sat, 13 Jan
                                                    2018</p>
            ...
            <div class="card-body">
                ...
                <div class="fluid-container">
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                        <div class="col-md-1">
                            <img class="img-sm rounded-circle mb-4 mb-md-0"
                                 src="/admin/images/faces/face1.jpg" alt="profile image">
                        </div>
                        <div class="ticket-details col-md-9">
                            <div class="d-flex">
                                <p class="text-dark font-weight-bold mr-2 mb-0 no-wrap">James :</p>
                                <p class="font-weight-medium mr-1 mb-0">[#23047]</p>
                                <p class="font-weight-semibold mb-0 ellipsis">Donec rutrum congue leo
                                    eget malesuada.</p>
                            </div>
                            <p class="text-small text-gray mb-2">Donec rutrum congue leo eget malesuada.
                                Quisque velit nisi, pretium ut lacinia in, elementum id enim
                                vivamus.</p>
                            <div class="row text-gray d-md-flex d-none">
                                <div class="col-4 d-flex">
                                    <p class="mb-0 mr-2 text-muted text-muted">Last responded :</p>
                                    <p class="Last-responded mr-2 mb-0 text-muted text-muted">3 hours
                                        ago</p>
                                </div>
                                <div class="col-4 d-flex">
                        ...
                        <div class="ticket-actions col-md-2">
                            <div class="btn-group dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="#"><i class="fa fa-reply fa-fw"></i>Quick
                                        reply</a>
                    ...
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                        <div class="col-md-1">
                            <img class="img-sm rounded-circle mb-4 mb-md-0"
                                 src="/admin/images/faces/face2.jpg" alt="profile image">
                        </div>
                        <div class="ticket-details col-md-9">
                            <div class="d-flex">
                                <p class="text-dark font-weight-bold mr-2 mb-0 no-wrap">Stella :</p>
                                <p class="font-weight-medium mr-1 mb-0">[#23135]</p>
                                <p class="font-weight-semibold mb-0 ellipsis">Curabitur aliquet quam id
                                    dui posuere blandit.</p>
                            </div>
                            <p class="text-small text-gray mb-2">Pellentesque in ipsum id orci porta
                                dapibus. Sed porttitor lectus nibh. Curabitur non nulla sit amet
                                nisl.</p>
                            <div class="row text-gray d-md-flex d-none">
                                <div class="col-4 d-flex">
                    ...
                    <div class="row ticket-card mt-3">
                        <div class="col-md-1">
                            <img class="img-sm rounded-circle mb-4 mb-md-0"
                                 src="/admin/images/faces/face3.jpg" alt="profile image">
                        </div>
                        <div class="ticket-details col-md-9">
                            <div class="d-flex">
                                <p class="text-dark font-weight-bold mr-2 mb-0 no-wrap">John Doe :</p>
                                <p class="font-weight-medium mr-1 mb-0">[#23246]</p>
                                <p class="font-weight-semibold mb-0 ellipsis">Mauris blandit aliquet
                                    elit, eget tincidunt nibh pulvinar.</p>
                            </div>
                            <p class="text-small text-gray mb-2">Nulla quis lorem ut libero malesuada
                                feugiat. Proin eget tortor risus. Lorem ipsum dolor sit amet.</p>
                            <div class="row text-gray d-md-flex d-none">
                                <div class="col-4 d-flex">
                                    <p class="mb-0 mr-2 text-muted">Last responded :</p>
                                    <p class="Last-responded mr-2 mb-0 text-muted">3 hours ago</p>
